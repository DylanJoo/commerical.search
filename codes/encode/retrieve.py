...
from ance import AnceDocumentEncoder
...
if __name__ == '__main__':
    ...
    encoder_parser.add_argument('--encoder-class', type=str, required=False, default=None,
                                choices=["dpr", "tct_colbert", "ance", "auto"])
    ...
    with embedding_writer:
        for batch_info in collection_iterator(args.encoder.batch_size, args.input.shard_id, args.input.shard_num):
            kwargs = {
                ...
                'descriptions': batch_info['description'] if 'description' in args.encoder.fields else None,
...
#     '/tmp2/trec/pds/indexes/ance-sim/',
#     'castorini/ance-msmarco-passage'
# )
# hits = searcher.search('Nike Kids Tanjun (GS) December Sky/White Running Shoe')
#
# for i in range(0, 10):
